...
(function ($, window, document, undefined) {
    ...
    _addCssProps: function () {
      ...
      for (; n < r; n++) {
        e[t[n].publicName] = (function (t) {
          return function (n) {
            if (n === undefined)
              return e[t.privateName] !== undefined
                ? e[t.privateName]
                : t.defaultValue;
            e[t.privateName] = n;
            return e;
  ...
  MagicWall.prototype = {
    ...
    updateOptions: function () {
      ...
      bp = t.userOptions.breakpoints
        ? t.userOptions.breakpoints.split(",")
        : [];
    ...
    setupStart: function () {
      ...
      t.elem
        .on(
          "mouseover",
          selectors.grid + "," + selectors.gridItem,
          function () {
    ...
    setupComplete: function () {
      ...
      if (
        t.options.autoUpdateOnResize !== false &&
        t.options.autoUpdateOnResize > 0
      ) {
    ...
    gridBuild: function () {
      ...
      for (; i < t.xCount * t.yCount; i++) {
        t.items
          .filter("[data-index=" + i + "]")
          .addClass(selectors.gridItem.slice(1));
      }
    ...
    gridCalculations: function () {
      ...
      if (t.options.columnsCount) {
        ...
        t.xCount =
          baseWidth / xCountMin > t.options.maxItemWidth
            ? xCountMax
            : xCountMin;
      ...
      if (t.options.rowsCount) {
        ...
        t.yCount =
          baseHeight / yCountMin > t.options.maxItemHeight
            ? yCountMax
            : yCountMin;
    ...
    parseAnimationOptions: function (o) {
      ...
      if (o.animation) {
        ...
        if (t.options.animations == "*") {
          ...
          anim = t.excludeAnimations(
            t.selectedAnimations[0] == "*"
              ? animations
              : t.selectedAnimations[0].split(",")
          );
      ...
      return $.extend(true, o, {
        ...
        duration:
          o.duration ||
          t.options[anim.replace("-", "") + "Duration"] ||
          t.options.duration,
        easing:
          o.easing ||
          t.options[anim.replace("-", "") + "Easing"] ||
          t.options.easing,
      });
    },
    ...
    switchItems: function (indexA, indexB, animation, duration, easing) {
      ...
      if (
        t.options.pauseOnHover == "all" &&
        t.itemsList.hasClass(selectors.hover.slice(1))
      )
        return false;
        ...
        if (o.type == "slideRow" || o.type == "slideColumn") {
          ...
          for (i = 0; i < (o.type == "slideRow" ? t.xCount : t.yCount); i++) {
            items = items.not(
              t.getItem(
                t.getIndex(
                  o.type == "slideRow" ? i : obj.px,
                  o.type == "slideRow" ? obj.py : i
                )
              )
            );
          }
    ...
    doSwitchItems: function (indexA, indexB, o) {
      ...
      var correctionAngle =
        (180 *
          Math.atan(
            (0.5 * (o.axis == "Y" ? t.itemHeight : t.itemWidth)) /
      ...
      switch (o.type) {
          ...
          if (
            {
              X:
                (objA.px > 0 && o.dir < 0) ||
                (objA.px < t.xCount - 1 && o.dir > 0),
              Y:
                (objA.py > 0 && o.dir < 0) ||
                (objA.py < t.yCount - 1 && o.dir > 0),
            }[o.axis]
          ) {
            itemC = t.getItem(
              t.getIndex(
          ...
          o.onUpdate = (function (a) {
            return function (v) {
              if (itemC) {
                ...
                a.css3d
                  .opacity(1 - Math.max(0, (Math.abs(v) - 40) / (120 - 40)))
                  .update();
              }
            };
          })(objA);
        ...
        case "slideColumn":
          ...
          for (i = 0; i < t.yCount - 1; i++) {
            var item = t.getItem(
                objB.index + (o.dir > 0 ? -1 : 1) * (i + 1) * t.xCount
              ),
              obj = t.getItemObject(item);
          ...
          objB.setIndex(
            objB.index + (o.dir > 0 ? -1 : 1) * t.xCount * (t.yCount - 1)
          );
          objB
